class BeersController < ApplicationController
  ...
  def beer_params
    params.require(:beer).permit(:name, :style_id, :alcohol_level, :color, :design_color, :beer_family_id, :bitterness, :description, :photo, :category_id, :target, :typical_beer_id)
  end
end
